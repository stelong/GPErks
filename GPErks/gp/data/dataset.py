...
class Dataset(Plottable):
    def __init__(
        ...
        msg = f"{self.name} dataset loaded. Discrepancy: {self.discrepancy:.6f}."
        # TODO: here we should read from the json file whether the author of the dataset provided an 'info' key.
        # A description of what the dataset is about in the 'info' field, then pass this to a self.descr attribute here.
        # Then this print(msg) should actually be a function that encapsulate all the description we want to display
        # about the dataset itself, e.g. size of the dataset, which x/y-labels, if it has Validation available: Yes/No
        # etc. Keeping it simple for the moment.
        # TODO: now this msg gets printed multiple times for all the y-labels that we have, fix this
        # TODO: pass self.name to Experiment, I remember some time ago I want to save something using Experiment name
        # but I cannot remember now what that is
        print(msg)
